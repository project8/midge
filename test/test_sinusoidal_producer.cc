...
{
    ofstream t_file;
    t_file.open( "test_sinusoidal_producer.log.txt", std::ios_base::trunc );
    ...
    t_rt_out->set_file( "test_sinusoidal_producer.signal.txt" );
    t_root->add( t_rt_out );
    ...
    t_rf_out->set_file( "test_sinusoidal_producer.spectrum.txt" );
    t_root->add( t_rf_out );
