...
namespace midge
{
    ...
    void line::update()
    {
        ...
        f_quality = f_total_score * f_correlation * f_correlation;
        ...
        //msg_warning( coremsg, "    total score is <" << f_total_score << ">" << eom );
    ...
    void line::print()
    {
        msg_normal( coremsg, "  line <" << f_id << ">" << eom );
        msg_normal( coremsg, "    score <" << f_score << ">" << eom );
        msg_normal( coremsg, "    quality <" << f_quality << ">" << eom );
        msg_normal( coremsg, "    time <" << f_time << ">" << eom );
        msg_normal( coremsg, "    frequency <" << f_frequency << ">" << eom );
        msg_normal( coremsg, "    slope <" << f_slope << ">" << eom );
        msg_normal( coremsg, "    duration <" << f_duration << ">" << eom );
        msg_normal( coremsg, "    correlation <" << f_correlation << ">" << eom );
        msg_normal( coremsg, "    deviation <" << f_deviation << ">" << eom );
        msg_normal( coremsg, "    high counts <" << f_high_count << "," << f_high.size() << ">" << eom );
        msg_normal( coremsg, "    global counts <" << f_global_count << "," << f_global.size() << ">" << eom );
        return;
    }
