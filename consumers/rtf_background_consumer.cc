#include "rtf_background_consumer.hh"
...
namespace midge
{
    ...
    rtf_background_consumer::rtf_background_consumer() :
            f_file( "" ),
            f_length( 0 ),
            f_window( NULL ),
            f_plot( false ),
    ...
    bool rtf_background_consumer::start_consumer()
    {
        if( f_plot == true )
        {
    ...
    bool rtf_background_consumer::execute_consumer()
    {
        for( count_t t_index = 0; t_index < f_size; t_index++ )
        {
    ...
    bool rtf_background_consumer::stop_consumer()
    {
