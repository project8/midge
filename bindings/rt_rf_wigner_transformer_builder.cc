...
namespace midge
{
    ...
    static const int s_rt_rf_wigner_transformer =
        ...
        rt_rf_wigner_transformer_builder::numerical< count_t >( &rt_rf_wigner_transformer::set_width, "width" ) +
        ...
        rt_rf_wigner_transformer_builder::object< window_blackman >( &rt_rf_wigner_transformer::set_window, "window_blackman" ) +
