...
namespace midge
{
    ...
    template< template< class, int > class x_socket, class x_list, int x_index = 0 >
    class typechain;

    template< template< class, int > class x_socket, class x_head, class x_tail, int x_index >
        ...
        public typechain< x_socket, x_tail, x_index + 1 >
    {
        public:
            typechain() :
                    ...
                    typechain< x_socket, x_tail, x_index + 1 >()
            {
            }
            ...
            typechain( x_1& p_1 ) :
                    ...
                    typechain< x_socket, x_tail, x_index + 1 >( p_1 )
            {
            }
            ...
            typechain( x_1& p_1, x_2& p_2 ) :
                    ...
                    typechain< x_socket, x_tail, x_index + 1 >( p_1, p_2 )
            {
            }
            ...
            typechain( x_1& p_1, x_2& p_2, x_3& p_3 ) :
                    ...
                    typechain< x_socket, x_tail, x_index + 1 >( p_1, p_2, p_3 )
            {
            }
            ...
            typechain( x_1& p_1, x_2& p_2, x_3& p_3, x_4& p_4 ) :
                    ...
                    typechain< x_socket, x_tail, x_index + 1 >( p_1, p_2, p_3, p_4 )
            {
            }
            ...
            typechain( x_1& p_1, x_2& p_2, x_3& p_3, x_4& p_4, x_5& p_5 ) :
                    ...
                    typechain< x_socket, x_tail, x_index + 1 >( p_1, p_2, p_3, p_4, p_5 )
            {
            }
    ...
    class typechain< x_socket, typenull, x_index >
    {
        public:
            typechain()
            {
