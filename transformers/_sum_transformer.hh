#ifndef _midge__sum_transformer_hh_
#define _midge__sum_transformer_hh_
...
namespace midge
{
    ...
    class _sum_transformer :
        public _transformer< _sum_transformer< x_type >, typelist_2( x_type, x_type ),typelist_1( x_type ) >
    {
        public:
            typedef _transformer< _sum_transformer< x_type >, typelist_2( x_type, x_type ),typelist_1( x_type ) > parent;

        public:
            _sum_transformer();
            virtual ~_sum_transformer();
    ...
    template< class x_type >
    _sum_transformer< x_type >::_sum_transformer() :
            f_length( 10 )
    {
    }
    template< class x_type >
    ...
    template< class x_type >
    void _sum_transformer< x_type >::initialize()
    {
    ...
    template< class x_type >
    void _sum_transformer< x_type >::finalize()
    {
