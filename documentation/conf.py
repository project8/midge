# -*- coding: utf-8 -*-
#
# Monarch documentation build configuration file, created by
# sphinx-quickstart on Thu Apr 23 11:11:03 2015.
#
...
os.environ['PROJECT_NAME'] = 'Midge'
os.environ['PROJECT_NUMBER'] = this_version
os.environ['PROJECT_BRIEF_DESC'] = 'Data Processing Framework'
...
os.environ['DOXYGEN_INPUT'] = 'doxfiles ../library  ../main  ../test'
...
project = u'Midge'
copyright = u'2018, Midge Authors'
...
latex_documents = [
  (master_doc, 'Midge.tex', u'Midge Documentation',
...
man_pages = [
    (master_doc, 'midge', u'Midge Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Midge', 'Midge Documentation',
   author, 'Midge', 'Data processing framework',
   'Miscellaneous'),
]
